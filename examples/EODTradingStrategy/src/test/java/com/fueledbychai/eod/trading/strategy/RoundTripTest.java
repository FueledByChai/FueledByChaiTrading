 ...
 */
package com.fueledbychai.eod.trading.strategy;

import static com.fueledbychai.eod.trading.strategy.TradeReferenceLine.Direction.LONG;
import static com.fueledbychai.eod.trading.strategy.TradeReferenceLine.Direction.SHORT;
import static com.fueledbychai.eod.trading.strategy.TradeReferenceLine.Side.ENTRY;
import static com.fueledbychai.eod.trading.strategy.TradeReferenceLine.Side.EXIT;
...
public class RoundTripTest {
    ...
    public void testGetResults() {
        Ticker shortTicker = new Ticker("SPY").setInstrumentType(InstrumentType.STOCK);
        String expected = "2016-03-03T05:30:45,Long,QQQ,100,50.43,0,2016-03-04T12:45:00,51.46,0,Short,SPY,50,1.23,0,2.34,0";
        ZonedDateTime entryDate = ZonedDateTime.of(2016, 3, 3, 5, 30, 45, 0, ZoneId.of("UTC"));
        ZonedDateTime exitDate = ZonedDateTime.of(2016, 3, 4, 12, 45, 00, 0, ZoneId.of("UTC"));
        ...
        OrderTicket shortEntryOrder = new OrderTicket("345", shortTicker, BigDecimal.valueOf(50), TradeDirection.SELL);
        shortEntryOrder.setFilledPrice(BigDecimal.valueOf(1.23));

        OrderTicket shortExitOrder = new OrderTicket("456", shortTicker, BigDecimal.valueOf(50), TradeDirection.BUY);
        shortExitOrder.setFilledPrice(BigDecimal.valueOf(2.34));
        shortExitOrder.setOrderFilledTime(exitDate);
