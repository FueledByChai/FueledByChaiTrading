...
/**
 * BouncyCastle-based Stark curve signing primitive (hash -> (r,s)).
 *
 * <p>
 * This is a generic Stark-curve ECDSA signer (RFC-6979 deterministic k via
 * HMAC-SHA256) and is exchange agnostic. It produces the same (r, s) pair as
 * the {@code starknet-rs} {@code sign_message} routine used by Extended's
 * {@code fast_stark_crypto} wrapper.
 * </p>
 */
