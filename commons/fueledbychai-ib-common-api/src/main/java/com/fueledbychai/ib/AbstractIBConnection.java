...
public abstract class AbstractIBConnection implements IBConnectionInterface {

    protected static final Logger logger = LoggerFactory.getLogger(AbstractIBConnection.class);
    ...
    public void tickGeneric(int tickerId, int tickType, double value) {
        // TODO Auto-generated method stub
        logger.warn("tickGeneric not implemented for tickerId: " + tickerId + ", tickType: " + tickType + ", value: "
                + value);
    ...
    public void tickPrice(int tickerId, int field, double price, TickAttrib attrib) {
        logger.info("tickPrice not implemented for tickerId: " + tickerId + ", field: " + field + ", price: " + price
                + ", attrib: " + attrib);
        // TODO Auto-generated method stub
    ...
    public void tickSize(int tickerId, int field, Decimal size) {
        logger.info("tickSize not implemented for tickerId: " + tickerId + ", field: " + field + ", size: " + size);
        // TODO Auto-generated method stub
    ...
    public void tickString(int tickerId, int tickType, String value) {
        logger.info("tickString not implemented for tickerId: " + tickerId + ", tickType: " + tickType + ", value: "
                + value);
        // TODO Auto-generated method stub
    ...
    public void updateAccountTime(String timeStamp) {
        logger.info("updateAccountTime not implemented for timeStamp: " + timeStamp);
        // TODO Auto-generated method stub
    ...
    public void verifyAndAuthCompleted(boolean isSuccessful, String errorText) {
        logger.info("verifyAndAuthCompleted not implemented for isSuccessful: " + isSuccessful + ", errorText: "
                + errorText);
        // TODO Auto-generated method stub
    ...
    public void verifyAndAuthMessageAPI(String apiData, String xyzChallenge) {
        logger.info(
                "verifyAndAuthMessageAPI not implemented for apiData: " + apiData + ", xyzChallenge: " + xyzChallenge);
        // TODO Auto-generated method stub
    ...
    public void verifyCompleted(boolean isSuccessful, String errorText) {
        logger.info("verifyCompleted not implemented for isSuccessful: " + isSuccessful + ", errorText: " + errorText);
        // TODO Auto-generated method stub
    ...
    public void verifyMessageAPI(String apiData) {
        logger.info("verifyMessageAPI not implemented for apiData: " + apiData);
        // TODO Auto-generated method stub
