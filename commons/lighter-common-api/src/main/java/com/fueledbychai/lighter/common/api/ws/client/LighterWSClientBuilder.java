...
public class LighterWSClientBuilder {
    ...
    public static final String WS_TYPE_ACCOUNT_STATS = "user_stats";
    ...
    public static LighterWebSocketClient buildAccountOrdersClient(String url, int marketIndex, long accountIndex,
            String authToken, IWebSocketProcessor processor) throws Exception {
        return buildClient(url, getAccountOrdersChannel(marketIndex, accountIndex), authToken, processor);
    }

    public static LighterWebSocketClient buildAccountStatsClient(String url, long accountIndex,
            IWebSocketProcessor processor) throws Exception {
        return buildClient(url, getAccountStatsChannel(accountIndex), processor);
    }
    ...
    public static LighterWebSocketClient buildTickerClient(String url, int marketId, IWebSocketProcessor processor)
            throws Exception {
        return buildClient(url, getTickerChannel(marketId), processor);
    }
    ...
    public static String getAccountOrdersChannel(int marketIndex, long accountIndex) {
        if (marketIndex < 0) {
    ...
    public static String getAccountStatsChannel(long accountIndex) {
        ...
        return WS_TYPE_ACCOUNT_STATS + "/" + accountIndex;
    }
}
