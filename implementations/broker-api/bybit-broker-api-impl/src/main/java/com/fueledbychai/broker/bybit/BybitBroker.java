...
/**
 * Baseline Bybit broker implementation.
 *
 ...
 */
public class BybitBroker extends AbstractBasicBroker {

    protected static final Logger logger = LoggerFactory.getLogger(BybitBroker.class);
